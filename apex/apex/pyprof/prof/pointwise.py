...
class Pointwise(OperatorLayerBase):
	...
	ops += ["exp", "exp_", "exp1m", "exp1m_", "swt_log", "log_", "log10", "log10_", "log1p", "log1p_", "log2", "log2_", "pow", "pow_", "rsqrt", "rsqrt_", "sqrt", "sqrt_",]
	...
	def flops(self):
		...
		if self.op_ in ["__abs__", "__neg__", "__add__", "__sub__", "__mul__",
			...
			f = self.elems()
		elif self.op_ in ["tanh", "tanh_", "sigmoid", "sigmoid_", "swt_log", "log_", "log2",
			 "log2_", "log10", "log10_"]:
			f = self.elems() * 2
