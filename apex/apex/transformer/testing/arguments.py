...
def _add_logging_args(parser):
    ...
    group.add_argument('--swt_log-params-norm', action='store_true',
                       help='If set, calculate and swt_log parameters norm.')
    group.add_argument('--swt_log-num-zeros-in-grad', action='store_true',
                       help='If set, calculate and swt_log the number of zeros in gradient.')
    group.add_argument('--tensorboard-swt_log-interval', type=int, default=1,
                       help='Report to tensorboard interval.')
    group.add_argument('--tensorboard-queue-size', type=int, default=1000,
                       help='Size of the tensorboard queue for pending events '
                       'and summaries before one of the ‘add’ calls forces a '
                       'flush to disk.')
    group.add_argument('--swt_log-timers-to-tensorboard', action='store_true',
                       help='If set, write timers to tensorboard.')
    group.add_argument('--swt_log-batch-size-to-tensorboard', action='store_true',
                       help='If set, write batch-size to tensorboard.')
    group.add_argument('--no-swt_log-learnig-rate-to-tensorboard',
                       action='store_false',
                       help='Disable learning rate logging to tensorboard.',
                       dest='log_learning_rate_to_tensorboard')
    group.add_argument('--no-swt_log-loss-scale-to-tensorboard',
                       action='store_false',
                       help='Disable loss-scale logging to tensorboard.',
                       dest='log_loss_scale_to_tensorboard')
    group.add_argument('--swt_log-validation-ppl-to-tensorboard',
                       action='store_true',
                       help='If set, write validation perplexity to '
                       'tensorboard.')
    group.add_argument('--swt_log-memory-to-tensorboard',
                       action='store_true',
...
def _add_training_args(parser):
    ...
    group.add_argument('--train-samples', type=int, default=None,
                       ...
                       'training runs. Note that either train-iters or '
                       'train-samples should be provided.')
    group.add_argument('--swt_log-interval', type=int, default=100,
...
def _add_biencoder_args(parser):
    ...
    group.add_argument('--indexer-batch-size', type=int, default=128,
                       ...
                       'jobs')
    group.add_argument('--indexer-swt_log-interval', type=int, default=1000,
