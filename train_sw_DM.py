...
W2 = 10
NUM_WORKERS = 32
LOG_DIR = './train_sw_DM_log1118_1'
NPZ = True
CKPT_DIR = './ckp_sw_DM_1'
P = 0.2
# lastCkptPath = '/p300/SWRNET/ckp_repDnet_6/ckpt99_trainMAE_0.288.pt'
lastCkptPath = r'/p300/SWRNET/ckp_sw_DM_1/ckpt6_trainMAE_0.705.pt'
if platform.system() == 'Windows':
    NUM_WORKERS = 0
    lastCkptPath = None
    BATCH_SIZE = 2
...
if __name__ == '__main__':
    ...
    for epoch in ep_pbar:
        ...
        for datas, target1, count in pbar:
            ...
            # 向前传播
            with autocast():
                y1, sim_matrix = model(datas)  # output : y1 :[b,f]  sim_matrix:[b,1,f,f]
